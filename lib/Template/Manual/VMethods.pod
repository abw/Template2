...
current list. Also returns the list (so you'll need to capture it
if you're not doing something else after, to stop it being printed).

    [% one   = [ 1 2 3 ];
       two   = [ 4 5 6 ];
       three = [ 7 8 9 ];
       dummy = one.import(two, three);
